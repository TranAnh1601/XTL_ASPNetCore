...
namespace XTL_ASPNetCore.Areas.Files.Controllers
{
    [Area("Files")]
    ...
    public class FileManagerController : Controller
    {
        ...
        private Connector GetConnector()
        {
            ...
            // .. ... wwww/files
            //ContentRootPath tra ve duong dan vat ly thuc luu tren o dia
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "File Manager", // Beautiful name given to the root/home folder
